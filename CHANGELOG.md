- V2.13.0
    - new flag `-w/--case-insensitive-path`, for correctly checking file overwrites in file systems like NTFS (mostly in Windows). []#28](https://github.com/shenwei356/brename/issues/28).
- v2.12.0
